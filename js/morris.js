...
(function() {
  ...
  Morris.Hover = (function() {
    ...
    Hover.prototype.moveTo = function(x, y, centre_y) {
      ...
      console.log('left: ' + parseInt(left) + ', rect.left: ' + parseInt(rect.left) + ', document.body.scrollLeft: ' + parseInt(document.body.scrollLeft) + ', window.scrollX: ' + parseInt(window.scrollX));
      console.log('top: ' + parseInt(top) + ', rect.top: ' + parseInt(rect.top) + ', document.body.scrollTop: ' + parseInt(document.body.scrollTop) + ', window.scrollY: ' + parseInt(window.scrollY) + ', document.getElementById(@options.parent.id).scrollTop: ' + document.getElementById(this.options.parent.id).scrollTop);
